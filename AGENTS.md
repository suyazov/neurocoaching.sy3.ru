...
- The pending1.0.24 package also includes the Career statement follow-up: three client-marked gaps before/after the zigzag and before the divider are32px. Remove mobile420px min-height/auto-margin stretch, retain desktop. Verified320/375/390/430 and desktop1440. See `docs/qa/career-statement-spacing-20260906/README.md`. Combined candidate CSS SHA `d99dcb2458b4bbfcbf14a1b3a771c89d27a018afd1ba17cbc4067aa97f2d6a48`; production still1.0.23 pending renewed admin login and fresh backup.
