	...
	<section class="site-section site-shell site-services neuro-services neuro-wrap" aria-labelledby="neuro-services-title">
		...
		<div class="site-service-grid neuro-service-grid">
			...
			<article class="site-service-card site-service-card--featured neuro-card neuro-card--featured">
				<span class="neuro-card__flag">Flagship</span><h3>Integrated<br>Transformation</h3><p class="neuro-card__label">Career strategy +<br class="neuro-card__mobile-break"> NeuroSprint in parallel<br>3 weeks<span class="neuro-card__desktop-separator"> · </span><br class="neuro-card__mobile-break">8 sessions personalised support</p><span class="neuro-waves" aria-hidden="true">≋</span>
