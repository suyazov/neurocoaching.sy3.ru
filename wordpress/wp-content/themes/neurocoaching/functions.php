...
function neurocoaching_header( $active ) {
	...
	<header class="site-header" data-site-header>
		<a class="brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="Digital Belka home"><?php if ( $is_about ) : ?><picture><source media="(max-width: 850px)" srcset="<?php echo esc_url( $about_images . 'about-header-logo-psd.png' ); ?>"><img src="<?php echo esc_url( $about_images . 'about-logo.png' ); ?>" width="110" height="55" alt="Digital Belka"></picture><?php else : ?><img src="<?php echo esc_url( get_theme_file_uri( '/assets/images/logo.png' ) ); ?>" alt="Digital Belka"><?php endif; ?></a>
		<div class="about-socials" aria-label="Social links">
			<a href="<?php echo esc_url( neurocoaching_mod( 'contact_url', 'https://www.linkedin.com/' ) ); ?>" aria-label="LinkedIn"><?php if ( $is_about ) : ?><picture><source media="(max-width: 850px)" srcset="<?php echo esc_url( $about_images . 'about-header-linkedin-psd.png' ); ?>"><img src="<?php echo esc_url( $about_images . 'about-linkedin.svg' ); ?>" width="28" height="28" alt=""></picture><?php else : ?><img src="<?php echo esc_url( $about_images . 'about-linkedin.svg' ); ?>" alt=""><?php endif; ?></a>
			<a href="<?php echo esc_url( neurocoaching_mod( 'instagram_url', 'https://www.instagram.com/' ) ); ?>" aria-label="Instagram"><?php if ( $is_about ) : ?><picture><source media="(max-width: 850px)" srcset="<?php echo esc_url( $about_images . 'about-header-instagram-psd.png' ); ?>"><img src="<?php echo esc_url( $about_images . 'about-instagram.svg' ); ?>" width="28" height="28" alt=""></picture><?php else : ?><img src="<?php echo esc_url( $about_images . 'about-instagram.svg' ); ?>" alt=""><?php endif; ?></a>
			<a href="<?php echo esc_url( neurocoaching_mod( 'telegram_url', 'https://t.me/' ) ); ?>" aria-label="Telegram"><?php if ( $is_about ) : ?><picture><source media="(max-width: 850px)" srcset="<?php echo esc_url( $about_images . 'about-header-telegram-psd.png' ); ?>"><img src="<?php echo esc_url( $about_images . 'about-telegram.svg' ); ?>" width="30" height="30" alt=""></picture><?php else : ?><img src="<?php echo esc_url( $about_images . 'about-telegram.svg' ); ?>" alt=""><?php endif; ?></a>
		</div>
